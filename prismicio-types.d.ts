...
type WebsiteDocumentDataSlicesSlice = ImagesSliceSlice | TextSliceSlice | VideoSlideSlice
...
interface WebsiteDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	weblink: prismic.LinkField<string, string, unknown, prismic.FieldState, never>;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type WebsiteDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<WebsiteDocumentData>, "website", Lang>;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type WebsitesDocument<Lang extends string = string> = prismic.PrismicDocumentWithoutUID<Simplify<WebsitesDocumentData>, "websites", Lang>;

export type AllDocumentTypes = ContactDocument | HomeDocument | MentionsDocument | MenuDocument | WebsiteDocument | WebsitesDocument;
...
export interface ImagesSliceSliceDefaultPrimary {
	 ...
	 */
	images: prismic.GroupField<Simplify<ImagesSliceSliceDefaultPrimaryImagesItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ImagesSliceSliceDefault = prismic.SharedSliceVariation<"default", Simplify<ImagesSliceSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ImagesSliceSlice = prismic.SharedSlice<"images_slice", ImagesSliceSliceVariation>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type VideoSlideSliceDefault = prismic.SharedSliceVariation<"default", Simplify<VideoSlideSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type VideoSlideSlice = prismic.SharedSlice<"video_slide", VideoSlideSliceVariation>;
